...
get_error_msg(335544323) -> "file ~p is not a valid database~n";
...
get_error_msg(335544333) -> "internal Firebird consistency check (~p)~n";
get_error_msg(335544334) -> "conversion error from string '~p'~n";
get_error_msg(335544335) -> "database file appears corrupt (~p)~n";
get_error_msg(335544336) -> "deadlock~n";
get_error_msg(335544337) -> "attempt to start more than ~p transactions~n";
...
get_error_msg(335544342) -> "action cancelled by trigger (~p) to preserve data integrity~n";
get_error_msg(335544343) -> "invalid request BLR at offset ~p~n";
get_error_msg(335544344) -> "I/O error during '~p' operation for file '~p'~n";
get_error_msg(335544345) -> "lock conflict on no wait transaction~n";
get_error_msg(335544346) -> "corrupt system table~n";
get_error_msg(335544347) -> "validation error for column ~p, value '~p'~n";
get_error_msg(335544348) -> "no current record for fetch operation~n";
get_error_msg(335544349) -> "attempt to store duplicate value (visible to active transactions) in unique index '~p'~n";
...
get_error_msg(335544352) -> "no permission for ~p access to ~p ~p~n";
...
get_error_msg(335544357) -> "cannot disconnect database with open transactions (~p active)~n";
get_error_msg(335544358) -> "message length error (encountered ~p, expected ~p)~n";
...
get_error_msg(335544362) -> "cannot update read-only view ~p~n";
...
get_error_msg(335544373) -> "operating system directive ~p failed~n";
...
get_error_msg(335544376) -> "table ~p was omitted from the transaction reserving list~n";
...
get_error_msg(335544379) -> "unsupported on-disk structure for file ~p; found ~p.~p, support ~p.~p~n";
get_error_msg(335544380) -> "wrong number of arguments on call~n";
get_error_msg(335544381) -> "Implementation limit exceeded~n";
get_error_msg(335544382) -> "~p~n";
get_error_msg(335544383) -> "unrecoverable conflict with limbo transaction ~p~n";
...
get_error_msg(335544390) -> "BLR syntax error: expected ~p at offset ~p, encountered ~p~n";
...
get_error_msg(335544395) -> "table ~p is not defined~n";
get_error_msg(335544396) -> "column ~p is not defined in table ~p~n";
...
get_error_msg(335544403) -> "page ~p is of wrong type (expected ~p, found ~p)~n";
get_error_msg(335544404) -> "database corrupted~n";
get_error_msg(335544405) -> "checksum error on database page ~p~n";
...
get_error_msg(335544412) -> "unsupported BLR version (expected ~p, encountered ~p)~n";
get_error_msg(335544413) -> "wrong version of database parameter block~n";
get_error_msg(335544414) -> "BLOB and array data types are not supported for ~p operation~n";
...
get_error_msg(335544433) -> "communication error with journal '~p'~n";
get_error_msg(335544434) -> "key size exceeds implementation restriction for index '~p'~n";
get_error_msg(335544435) -> "null segment of UNIQUE KEY~n";
get_error_msg(335544436) -> "SQL error code = ~p~n";
get_error_msg(335544437) -> "wrong DYN version~n";
get_error_msg(335544438) -> "function ~p is not defined~n";
get_error_msg(335544439) -> "function ~p could not be matched~n";
get_error_msg(335544440) -> "~n";
get_error_msg(335544441) -> "database detach completed with errors~n";
get_error_msg(335544442) -> "database system cannot read argument ~p~n";
get_error_msg(335544443) -> "database system cannot write argument ~p~n";
get_error_msg(335544444) -> "operation not supported~n";
get_error_msg(335544445) -> "~p extension error~n";
...
get_error_msg(335544450) -> "~p~n";
get_error_msg(335544451) -> "update conflicts with concurrent update~n";
get_error_msg(335544452) -> "product ~p is not licensed~n";
get_error_msg(335544453) -> "object ~p is in use~n";
get_error_msg(335544454) -> "filter not found to convert type ~p to type ~p~n";
get_error_msg(335544455) -> "cannot attach active shadow file~n";
get_error_msg(335544456) -> "invalid slice description language at offset ~p~n";
get_error_msg(335544457) -> "subscript out of bounds~n";
get_error_msg(335544458) -> "column not array or invalid dimensions (expected ~p, encountered ~p)~n";
get_error_msg(335544459) -> "record from transaction ~p is stuck in limbo~n";
get_error_msg(335544460) -> "a file in manual shadow ~p is unavailable~n";
...
get_error_msg(335544463) -> "generator ~p is not defined~n";
...
get_error_msg(335544466) -> "violation of FOREIGN KEY constraint '~p' on table '~p'~n";
get_error_msg(335544467) -> "minor version too high found ~p expected ~p~n";
get_error_msg(335544468) -> "transaction ~p is ~p~n";
get_error_msg(335544469) -> "transaction marked invalid and cannot be committed~n";
get_error_msg(335544470) -> "cache buffer for page ~p invalid~n";
get_error_msg(335544471) -> "there is no index in table ~p with id ~p~n";
...
get_error_msg(335544474) -> "invalid lock level ~p~n";
get_error_msg(335544475) -> "lock on table ~p conflicts with existing lock~n";
get_error_msg(335544476) -> "requested record lock conflicts with existing lock~n";
get_error_msg(335544477) -> "maximum indexes per table (~p) exceeded~n";
...
get_error_msg(335544488) -> "Log file header of ~p too small~n";
get_error_msg(335544489) -> "Invalid version of log file ~p~n";
get_error_msg(335544490) -> "Log file ~p not latest in the chain but open flag still set~n";
get_error_msg(335544491) -> "Log file ~p not closed properly; database recovery may be required~n";
get_error_msg(335544492) -> "Database name in the log file ~p is different~n";
get_error_msg(335544493) -> "Unexpected end of log file ~p at offset ~p~n";
get_error_msg(335544494) -> "Incomplete log record at offset ~p in log file ~p~n";
get_error_msg(335544495) -> "Log record header too small at offset ~p in log file ~p~n";
get_error_msg(335544496) -> "Log block too small at offset ~p in log file ~p~n";
get_error_msg(335544497) -> "Illegal attempt to attach to an uninitialized WAL segment for ~p~n";
get_error_msg(335544498) -> "Invalid WAL parameter block option ~p~n";
get_error_msg(335544499) -> "Cannot roll over to the next log file ~p~n";
...
get_error_msg(335544506) -> "database ~p shutdown in progress~n";
get_error_msg(335544507) -> "refresh range number ~p already in use~n";
get_error_msg(335544508) -> "refresh range number ~p not found~n";
get_error_msg(335544509) -> "CHARACTER SET ~p is not defined~n";
get_error_msg(335544510) -> "lock time-out on wait transaction~n";
get_error_msg(335544511) -> "procedure ~p is not defined~n";
get_error_msg(335544512) -> "Input parameter mismatch for procedure ~p~n";
get_error_msg(335544513) -> "Database ~p: WAL subsystem bug for pid ~p~p~n";
get_error_msg(335544514) -> "Could not expand the WAL segment for database ~p~n";
get_error_msg(335544515) -> "status code ~p unknown~n";
get_error_msg(335544516) -> "exception ~p not defined~n";
get_error_msg(335544517) -> "exception ~p~n";
...
get_error_msg(335544527) -> "Cannot start WAL writer for the database ~p~n";
get_error_msg(335544528) -> "database ~p shutdown~n";
...
get_error_msg(335544558) -> "Operation violates CHECK constraint ~p on view or table ~p~n";
get_error_msg(335544559) -> "invalid service handle~n";
get_error_msg(335544560) -> "database ~p shutdown in ~p seconds~n";
...
get_error_msg(335544563) -> "service ~p is not defined~n";
...
get_error_msg(335544568) -> "Implementation of text subtype ~p not located.~n";
...
get_error_msg(335544575) -> "Cursor ~p is not updatable~n";
...
get_error_msg(335544588) -> "COLLATION ~p for CHARACTER SET ~p is not defined~n";
get_error_msg(335544589) -> "COLLATION ~p is not valid for specified CHARACTER SET~n";
...
get_error_msg(335544609) -> "INDEX ~p~n";
get_error_msg(335544610) -> "EXCEPTION ~p~n";
get_error_msg(335544611) -> "COLUMN ~p~n";
...
get_error_msg(335544620) -> "alias ~p conflicts with an alias in the same statement~n";
get_error_msg(335544621) -> "alias ~p conflicts with a procedure in the same statement~n";
get_error_msg(335544622) -> "alias ~p conflicts with a table in the same statement~n";
get_error_msg(335544623) -> "Illegal use of keyword VALUE~n";
get_error_msg(335544624) -> "segment count of 0 defined for index ~p~n";
get_error_msg(335544625) -> "A node name is not permitted in a secondary, shadow, cache or log file name~n";
get_error_msg(335544626) -> "TABLE ~p~n";
get_error_msg(335544627) -> "PROCEDURE ~p~n";
get_error_msg(335544628) -> "cannot create index ~p~n";
get_error_msg(335544629) -> "Write-ahead Log with shadowing configuration not allowed~n";
get_error_msg(335544630) -> "there are ~p dependencies~n";
get_error_msg(335544631) -> "too many keys defined for index ~p~n";
get_error_msg(335544632) -> "Preceding file did not specify length, so ~p must include starting page number~n";
get_error_msg(335544633) -> "Shadow number must be a positive integer~n";
get_error_msg(335544634) -> "Token unknown - line ~p, column ~p~n";
get_error_msg(335544635) -> "there is no alias or table named ~p at this scope level~n";
get_error_msg(335544636) -> "there is no index ~p for table ~p~n";
get_error_msg(335544637) -> "table ~p is not referenced in plan~n";
get_error_msg(335544638) -> "table ~p is referenced more than once in plan; use aliases to distinguish~n";
get_error_msg(335544639) -> "table ~p is referenced in the plan but not the from list~n";
get_error_msg(335544640) -> "Invalid use of CHARACTER SET or COLLATE~n";
get_error_msg(335544641) -> "Specified domain or source column ~p does not exist~n";
get_error_msg(335544642) -> "index ~p cannot be used in the specified plan~n";
get_error_msg(335544643) -> "the table ~p is referenced twice; use aliases to differentiate~n";
...
get_error_msg(335544656) -> "variable ~p conflicts with parameter in same procedure~n";
get_error_msg(335544657) -> "Array/BLOB/DATE data types not allowed in arithmetic~n";
get_error_msg(335544658) -> "~p is not a valid base table of the specified view~n";
get_error_msg(335544659) -> "table ~p is referenced twice in view; use an alias to distinguish~n";
get_error_msg(335544660) -> "view ~p has more than one base table; use aliases to distinguish~n";
get_error_msg(335544661) -> "cannot add index, index root page is full.~n";
get_error_msg(335544662) -> "BLOB SUB_TYPE ~p is not defined~n";
get_error_msg(335544663) -> "Too many concurrent executions of the same request~n";
get_error_msg(335544664) -> "duplicate specification of ~p - not supported~n";
get_error_msg(335544665) -> "violation of PRIMARY or UNIQUE KEY constraint '~p' on table '~p'~n";
...
get_error_msg(335544668) -> "procedure ~p does not return any values~n";
get_error_msg(335544669) -> "count of column list and variable list do not match~n";
get_error_msg(335544670) -> "attempt to index BLOB column in index ~p~n";
get_error_msg(335544671) -> "attempt to index array column in index ~p~n";
get_error_msg(335544672) -> "too few key columns found for index ~p (incorrect column name?)~n";
...
get_error_msg(335544679) -> "segments not allowed in expression index ~p~n";
get_error_msg(335544680) -> "sort error: corruption in data structure~n";
get_error_msg(335544681) -> "new record size of ~p bytes is too big~n";
...
get_error_msg(335544684) -> "cannot access column ~p in view ~p~n";
...
get_error_msg(335544703) -> "service ~p does not have an associated executable~n";
get_error_msg(335544704) -> "Failed to locate host machine.~n";
get_error_msg(335544705) -> "Undefined service ~p/~p.~n";
...
get_error_msg(335544710) -> "navigational stream ~p references a view with more than one base table~n";
...
get_error_msg(335544715) -> "Operation not supported for EXTERNAL FILE table ~p~n";
get_error_msg(335544716) -> "Service is currently busy: ~p~n";
...
get_error_msg(335544720) -> "Unable to load required library ~p.~n";
get_error_msg(335544721) -> "Unable to complete network request to host '~p'.~n";
...
get_error_msg(335544745) -> "Your login ~p is same as one of the SQL role name. Ask your database administrator to set up a valid Firebird login.~n";
...
get_error_msg(335544758) -> "sort record size of ~p bytes is too big~n";
get_error_msg(335544759) -> "can not define a not null column with NULL as default value~n";
get_error_msg(335544760) -> "invalid clause --- '~p'~n";
...
get_error_msg(335544766) -> "SQL dialect ~p is not supported in this database~n";
...
get_error_msg(335544780) -> "An exception occurred that does not have a description.  Exception number ~p.~n";
...
get_error_msg(335544790) -> "Service ~p requires SYSDBA permissions.  Reattach to the Service Manager using the SYSDBA account.~n";
get_error_msg(335544791) -> "The file ~p is currently in use by another process.  Try again later.~n";
get_error_msg(335544792) -> "Cannot attach to services manager~n";
get_error_msg(335544793) -> "Metadata update statement is not allowed by the current database SQL dialect ~p~n";
get_error_msg(335544794) -> "operation was cancelled~n";
get_error_msg(335544795) -> "unexpected item in service parameter block, expected ~p~n";
get_error_msg(335544796) -> "Client SQL dialect ~p does not support reference to ~p datatype~n";
...
get_error_msg(335544804) -> "Unable to create database ~p~n";
get_error_msg(335544805) -> "Database dialect ~p is not a valid dialect.~n";
get_error_msg(335544806) -> "Valid database dialects are ~p.~n";
get_error_msg(335544807) -> "SQL warning code = ~p~n";
get_error_msg(335544808) -> "DATE data type is now called TIMESTAMP~n";
get_error_msg(335544809) -> "Function ~p is in ~p, which is not in a permitted directory for external functions.~n";
get_error_msg(335544810) -> "value exceeds the range for valid dates~n";
get_error_msg(335544811) -> "passed client dialect ~p is not a valid dialect.~n";
get_error_msg(335544812) -> "Valid client dialects are ~p.~n";
...
get_error_msg(335544815) -> "GENERATOR ~p~n";
get_error_msg(335544816) -> "UDF ~p~n";
...
get_error_msg(335544820) -> "Unable to find savepoint with name ~p in transaction context~n";
get_error_msg(335544821) -> "Invalid column position used in the ~p clause~n";
...
get_error_msg(335544824) -> "Invalid expression in the ~p (not contained in either an aggregate function or the GROUP BY clause)~n";
get_error_msg(335544825) -> "Invalid expression in the ~p (neither an aggregate function nor a part of the GROUP BY clause)~n";
...
get_error_msg(335544828) -> "Wrong request type in EXECUTE STATEMENT '~p'~n";
get_error_msg(335544829) -> "Variable type (position ~p) in EXECUTE STATEMENT '~p' INTO does not match returned column type~n";
get_error_msg(335544830) -> "Too many recursion levels of EXECUTE STATEMENT~n";
get_error_msg(335544831) -> "Use of ~p at location ~p is not allowed by server configuration~n";
...
get_error_msg(335544835) -> "Target shutdown mode is invalid for database '~p'~n";
get_error_msg(335544836) -> "Concatenation overflow. Resulting string cannot exceed 32765 bytes in length.~n";
get_error_msg(335544837) -> "Invalid offset parameter ~p to SUBSTRING. Only positive integers are allowed.~n";
...
get_error_msg(335544842) -> "~p~n";
get_error_msg(335544843) -> "Context variable ~p is not found in namespace ~p~n";
get_error_msg(335544844) -> "Invalid namespace name ~p passed to ~p~n";
get_error_msg(335544845) -> "Too many context variables~n";
get_error_msg(335544846) -> "Invalid argument passed to ~p~n";
get_error_msg(335544847) -> "BLR syntax error. Identifier ~p... is too long~n";
get_error_msg(335544848) -> "exception ~p~n";
get_error_msg(335544849) -> "Malformed string~n";
get_error_msg(335544850) -> "Output parameter mismatch for procedure ~p~n";
get_error_msg(335544851) -> "Unexpected end of command - line ~p, column ~p~n";
get_error_msg(335544852) -> "partner index segment no ~p has incompatible data type~n";
get_error_msg(335544853) -> "Invalid length parameter ~p to SUBSTRING. Negative integers are not allowed.~n";
get_error_msg(335544854) -> "CHARACTER SET ~p is not installed~n";
get_error_msg(335544855) -> "COLLATION ~p for CHARACTER SET ~p is not installed~n";
...
get_error_msg(335544859) -> "Time precision exceeds allowed range (0-~p)~n";
get_error_msg(335544860) -> "Unsupported conversion to target type BLOB (subtype ~p)~n";
...
get_error_msg(335544863) -> "Cannot create foreign key constraint ~p. Partner index does not exist or is inactive.~n";
...
get_error_msg(335544866) -> "~p cannot depend on ~p~n";
get_error_msg(335544867) -> "Blob sub_types bigger than 1 (text) are for internal use only~n";
get_error_msg(335544868) -> "Procedure ~p is not selectable (it does not contain a SUSPEND statement)~n";
get_error_msg(335544869) -> "Datatype ~p is not supported for sorting operation~n";
get_error_msg(335544870) -> "COLLATION ~p~n";
get_error_msg(335544871) -> "DOMAIN ~p~n";
get_error_msg(335544872) -> "domain ~p is not defined~n";
get_error_msg(335544873) -> "Array data type can use up to ~p dimensions~n";
get_error_msg(335544874) -> "A multi database transaction cannot span more than ~p databases~n";
get_error_msg(335544875) -> "Bad debug info format~n";
get_error_msg(335544876) -> "Error while parsing procedure ~p's BLR~n";
get_error_msg(335544877) -> "index key too big~n";
get_error_msg(335544878) -> "concurrent transaction number is ~p~n";
get_error_msg(335544879) -> "validation error for variable ~p, value '~p'~n";
get_error_msg(335544880) -> "validation error for ~p, value '~p'~n";
get_error_msg(335544881) -> "Difference file name should be set explicitly for database on raw device~n";
get_error_msg(335544882) -> "Login name too long (~p characters, maximum allowed ~p)~n";
get_error_msg(335544883) -> "column ~p is not defined in procedure ~p~n";
...
get_error_msg(335544887) -> "Table reservation lock type ~p requires table name before in TPB~n";
get_error_msg(335544888) -> "Found more than one ~p specification in TPB~n";
get_error_msg(335544889) -> "Option ~p requires READ COMMITTED isolation in TPB~n";
get_error_msg(335544890) -> "Option ~p is not valid if ~p was used previously in TPB~n";
get_error_msg(335544891) -> "Table name length missing after table reservation ~p in TPB~n";
get_error_msg(335544892) -> "Table name length ~p is too long after table reservation ~p in TPB~n";
get_error_msg(335544893) -> "Table name length ~p without table name after table reservation ~p in TPB~n";
get_error_msg(335544894) -> "Table name length ~p goes beyond the remaining TPB size after table reservation ~p~n";
get_error_msg(335544895) -> "Table name length is zero after table reservation ~p in TPB~n";
get_error_msg(335544896) -> "Table or view ~p not defined in system tables after table reservation ~p in TPB~n";
get_error_msg(335544897) -> "Base table or view ~p for view ~p not defined in system tables after table reservation ~p in TPB~n";
get_error_msg(335544898) -> "Option length missing after option ~p in TPB~n";
get_error_msg(335544899) -> "Option length ~p without value after option ~p in TPB~n";
get_error_msg(335544900) -> "Option length ~p goes beyond the remaining TPB size after option ~p~n";
get_error_msg(335544901) -> "Option length is zero after table reservation ~p in TPB~n";
get_error_msg(335544902) -> "Option length ~p exceeds the range for option ~p in TPB~n";
get_error_msg(335544903) -> "Option value ~p is invalid for the option ~p in TPB~n";
get_error_msg(335544904) -> "Preserving previous table reservation ~p for table ~p, stronger than new ~p in TPB~n";
get_error_msg(335544905) -> "Table reservation ~p for table ~p already specified and is stronger than new ~p in TPB~n";
get_error_msg(335544906) -> "Table reservation reached maximum recursion of ~p when expanding views in TPB~n";
get_error_msg(335544907) -> "Table reservation in TPB cannot be applied to ~p because it's a virtual table~n";
get_error_msg(335544908) -> "Table reservation in TPB cannot be applied to ~p because it's a system table~n";
get_error_msg(335544909) -> "Table reservation ~p or ~p in TPB cannot be applied to ~p because it's a temporary table~n";
...
get_error_msg(335544920) -> "External Data Source provider '~p' not found~n";
get_error_msg(335544921) -> "Execute statement error at ~p :~pData source : ~p~n";
...
get_error_msg(335544925) -> "Unclosed comment found near '~p'~n";
get_error_msg(335544926) -> "Execute statement error at ~p :~pStatement : ~pData source : ~p~n";
get_error_msg(335544927) -> "Input parameters mismatch~n";
get_error_msg(335544928) -> "Output parameters mismatch~n";
get_error_msg(335544929) -> "Input parameter '~p' have no value set~n";
get_error_msg(335544930) -> "BLR stream length ~p exceeds implementation limit ~p~n";
...
get_error_msg(335544945) -> "Arguments for ~p must be integral types or NUMERIC/DECIMAL without scale~n";
get_error_msg(335544946) -> "First argument for ~p must be integral type or floating point type~n";
get_error_msg(335544947) -> "Human readable UUID argument for ~p must be of string type~n";
get_error_msg(335544948) -> "Human readable UUID argument for ~p must be of exact length ~p~n";
get_error_msg(335544949) -> "Human readable UUID argument for ~p must have '-' at position ~p instead of '~p'~n";
get_error_msg(335544950) -> "Human readable UUID argument for ~p must have hex digit at position ~p instead of '~p'~n";
get_error_msg(335544951) -> "Only HOUR, MINUTE, SECOND and MILLISECOND can be added to TIME values in ~p~n";
get_error_msg(335544952) -> "Invalid data type in addition of part to DATE/TIME/TIMESTAMP in ~p~n";
get_error_msg(335544953) -> "Invalid part ~p to be added to a DATE/TIME/TIMESTAMP value in ~p~n";
get_error_msg(335544954) -> "Expected DATE/TIME/TIMESTAMP type in evlDateAdd() result~n";
get_error_msg(335544955) -> "Expected DATE/TIME/TIMESTAMP type as first and second argument to ~p~n";
get_error_msg(335544956) -> "The result of TIME-<value> in ~p cannot be expressed in YEAR, MONTH, DAY or WEEK~n";
get_error_msg(335544957) -> "The result of TIME-TIMESTAMP or TIMESTAMP-TIME in ~p cannot be expressed in HOUR, MINUTE, SECOND or MILLISECOND~n";
get_error_msg(335544958) -> "The result of DATE-TIME or TIME-DATE in ~p cannot be expressed in HOUR, MINUTE, SECOND and MILLISECOND~n";
get_error_msg(335544959) -> "Invalid part ~p to express the difference between two DATE/TIME/TIMESTAMP values in ~p~n";
get_error_msg(335544960) -> "Argument for ~p must be positive~n";
get_error_msg(335544961) -> "Base for ~p must be positive~n";
get_error_msg(335544962) -> "Argument #~p for ~p must be zero or positive~n";
get_error_msg(335544963) -> "Argument #~p for ~p must be positive~n";
get_error_msg(335544964) -> "Base for ~p cannot be zero if exponent is negative~n";
get_error_msg(335544965) -> "Base for ~p cannot be negative if exponent is not an integral value~n";
get_error_msg(335544966) -> "The numeric scale must be between -128 and 127 in ~p~n";
get_error_msg(335544967) -> "Argument for ~p must be zero or positive~n";
get_error_msg(335544968) -> "Binary UUID argument for ~p must be of string type~n";
get_error_msg(335544969) -> "Binary UUID argument for ~p must use ~p bytes~n";
get_error_msg(335544970) -> "Missing required item ~p in service parameter block~n";
get_error_msg(335544971) -> "~p server is shutdown~n";
...
get_error_msg(335544976) -> "Argument for ~p must be different than zero~n";
get_error_msg(335544977) -> "Argument for ~p must be in the range [-1, 1]~n";
get_error_msg(335544978) -> "Argument for ~p must be greater or equal than one~n";
get_error_msg(335544979) -> "Argument for ~p must be in the range ]-1, 1[~n";
get_error_msg(335544980) -> "Incorrect parameters provided to internal function ~p~n";
get_error_msg(335544981) -> "Floating point overflow in built-in function ~p~n";
get_error_msg(335544982) -> "Floating point overflow in result from UDF ~p~n";
get_error_msg(335544983) -> "Invalid floating point value returned by UDF ~p~n";
...
get_error_msg(335544988) -> "PACKAGE ~p~n";
get_error_msg(335544989) -> "Cannot make field ~p of table ~p NOT NULL because there are NULLs present~n";
get_error_msg(335544990) -> "Feature ~p is not supported anymore~n";
get_error_msg(335544991) -> "VIEW ~p~n";
get_error_msg(335544992) -> "Can not access lock files directory ~p~n";
get_error_msg(335544993) -> "Fetch option ~p is invalid for a non-scrollable cursor~n";
get_error_msg(335544994) -> "Error while parsing function ~p's BLR~n";
get_error_msg(335544995) -> "Cannot execute function ~p of the unimplemented package ~p~n";
get_error_msg(335544996) -> "Cannot execute procedure ~p of the unimplemented package ~p~n";
get_error_msg(335544997) -> "External function ~p not returned by the external engine plugin ~p~n";
get_error_msg(335544998) -> "External procedure ~p not returned by the external engine plugin ~p~n";
get_error_msg(335544999) -> "External trigger ~p not returned by the external engine plugin ~p~n";
get_error_msg(335545000) -> "Incompatible plugin version ~p for external engine ~p~n";
get_error_msg(335545001) -> "External engine ~p not found~n";
get_error_msg(335545002) -> "Attachment is in use~n";
get_error_msg(335545003) -> "Transaction is in use~n";
get_error_msg(335545004) -> "Error loading plugin ~p~n";
get_error_msg(335545005) -> "Loadable module ~p not found~n";
get_error_msg(335545006) -> "Standard plugin entrypoint does not exist in module ~p~n";
get_error_msg(335545007) -> "Module ~p exists but can not be loaded~n";
get_error_msg(335545008) -> "Module ~p does not contain plugin ~p type ~p~n";
...
get_error_msg(335545011) -> "Type ~p is incompatible with BLOB~n";
get_error_msg(335545012) -> "Invalid date~n";
get_error_msg(335545013) -> "Invalid time~n";
get_error_msg(335545014) -> "Invalid timestamp~n";
get_error_msg(335545015) -> "Invalid index ~p in function ~p~n";
get_error_msg(335545016) -> "~p~n";
get_error_msg(335545017) -> "Asynchronous call is already running for this attachment~n";
get_error_msg(335545018) -> "Function ~p is private to package ~p~n";
get_error_msg(335545019) -> "Procedure ~p is private to package ~p~n";
get_error_msg(335545020) -> "Request can't access new records in relation ~p and should be recompiled~n";
get_error_msg(335545021) -> "invalid events id (handle)~n";
get_error_msg(335545022) -> "Cannot copy statement ~p~n";
get_error_msg(335545023) -> "Invalid usage of boolean expression~n";
get_error_msg(335545024) -> "Arguments for ~p cannot both be zero~n";
get_error_msg(335545025) -> "missing service ID in spb~n";
get_error_msg(335545026) -> "External BLR message mismatch: invalid null descriptor at field ~p~n";
get_error_msg(335545027) -> "External BLR message mismatch: length = ~p, expected ~p~n";
get_error_msg(335545028) -> "Subscript ~p out of bounds [~p, ~p]~n";
get_error_msg(335545029) -> "Install incomplete, please read the Compatibility chapter in the release notes for this version~n";
get_error_msg(335545030) -> "~p operation is not allowed for system table ~p~n";
get_error_msg(335545031) -> "Libtommath error code ~p in function ~p~n";
get_error_msg(335545032) -> "unsupported BLR version (expected between ~p and ~p, encountered ~p)~n";
get_error_msg(335545033) -> "expected length ~p, actual ~p~n";
...
get_error_msg(335545039) -> "Crypt plugin ~p failed to load~n";
get_error_msg(335545040) -> "Length of crypt plugin name should not exceed ~p bytes~n";
...
get_error_msg(335545046) -> "Maximum (~p) number of arguments exceeded for function ~p~n";
get_error_msg(335545047) -> "External BLR message mismatch: names count = ~p, blr count = ~p~n";
get_error_msg(335545048) -> "External BLR message mismatch: name ~p not found~n";
...
get_error_msg(335545052) -> "Message metadata not ready - item ~p is not finished~n";
get_error_msg(335545053) -> "Missing configuration file: ~p~n";
get_error_msg(335545054) -> "~p: illegal line <~p>~n";
get_error_msg(335545055) -> "Invalid include operator in ~p for <~p>~n";
...
get_error_msg(335545060) -> "Missing security context for ~p~n";
get_error_msg(335545061) -> "Missing segment ~p in multisegment connect block parameter~n";
...
get_error_msg(335545066) -> "Client attempted to start wire encryption using unknown key ~p~n";
get_error_msg(335545067) -> "Client attempted to start wire encryption using unsupported plugin ~p~n";
...
get_error_msg(335545070) -> "Client authentication plugin expected ~p bytes of ~p from server, got ~p~n";
get_error_msg(335545071) -> "Attempt to get information about an unprepared dynamic SQL statement.~n";
get_error_msg(335545072) -> "Problematic key value is ~p~n";
get_error_msg(335545073) -> "Cannot select virtual table ~p for update WITH LOCK~n";
get_error_msg(335545074) -> "Cannot select system table ~p for update WITH LOCK~n";
get_error_msg(335545075) -> "Cannot select temporary table ~p for update WITH LOCK~n";
get_error_msg(335545076) -> "System ~p ~p cannot be modified~n";
...
get_error_msg(335545079) -> "Mapping ~p already exists~n";
get_error_msg(335545080) -> "Mapping ~p does not exist~n";
get_error_msg(335545081) -> "~p failed when loading mapping cache~n";
get_error_msg(335545082) -> "Invalid name <*> in authentication block~n";
get_error_msg(335545083) -> "Multiple maps found for ~p~n";
...
get_error_msg(335545086) -> "Attempt to set in database number of buffers which is out of acceptable range [~p:~p]~n";
get_error_msg(335545087) -> "Attempt to temporarily set number of buffers less than ~p~n";
get_error_msg(335545088) -> "Global mapping is not available when database ~p is not present~n";
get_error_msg(335545089) -> "Global mapping is not available when table RDB$MAP is not present in database ~p~n";
get_error_msg(335545090) -> "Your attachment has no trusted role~n";
get_error_msg(335545091) -> "Role ~p is invalid or unavailable~n";
get_error_msg(335545092) -> "Cursor ~p is not positioned in a valid record~n";
get_error_msg(335545093) -> "Duplicated user attribute ~p~n";
get_error_msg(335545094) -> "There is no privilege for this operation~n";
get_error_msg(335545095) -> "Using GRANT OPTION on ~p not allowed~n";
get_error_msg(335545096) -> "read conflicts with concurrent update~n";
get_error_msg(335545097) -> "~p failed when working with CREATE DATABASE grants~n";
get_error_msg(335545098) -> "CREATE DATABASE grants check is not possible when database ~p is not present~n";
get_error_msg(335545099) -> "CREATE DATABASE grants check is not possible when table RDB$DB_CREATORS is not present in database ~p~n";
get_error_msg(335545100) -> "Interface ~p version too old: expected ~p, found ~p~n";
get_error_msg(335545101) -> "Input parameter mismatch for function ~p~n";
get_error_msg(335545102) -> "Error during savepoint backout - transaction invalidated~n";
get_error_msg(335545103) -> "Domain used in the PRIMARY KEY constraint of table ~p must be NOT NULL~n";
get_error_msg(335545104) -> "CHARACTER SET ~p cannot be used as a attachment character set~n";
...
get_error_msg(335740929) -> "data base file name (~p) already given~n";
get_error_msg(335740930) -> "invalid switch ~p~n";
...
get_error_msg(335740995) -> "Transaction state ~p not in valid range.~n";
get_error_msg(335741012) -> "unexpected end of input~n";
get_error_msg(335741018) -> "failed to reconnect to a transaction in database ~p~n";
...
get_error_msg(336003076) -> "Use of ~p expression that returns different results in dialect 1 and dialect 3~n";
get_error_msg(336003077) -> "Database SQL dialect ~p does not support reference to ~p datatype~n";
get_error_msg(336003079) -> "DB dialect ~p and client dialect ~p conflict with respect to numeric precision ~p.~n";
get_error_msg(336003080) -> "WARNING: Numeric literal ~p is interpreted as a floating-point~n";
...
get_error_msg(336003085) -> "Ambiguous field name between ~p and ~p~n";
get_error_msg(336003086) -> "External function should have return position between 1 and ~p~n";
get_error_msg(336003087) -> "Label ~p ~p in the current scope~n";
get_error_msg(336003088) -> "Datatypes ~pare not comparable in expression ~p~n";
get_error_msg(336003089) -> "Empty cursor name is not allowed~n";
get_error_msg(336003090) -> "Statement already has a cursor ~p assigned~n";
get_error_msg(336003091) -> "Cursor ~p is not found in the current context~n";
get_error_msg(336003092) -> "Cursor ~p already exists in the current context~n";
get_error_msg(336003093) -> "Relation ~p is ambiguous in cursor ~p~n";
get_error_msg(336003094) -> "Relation ~p is not found in cursor ~p~n";
get_error_msg(336003095) -> "Cursor is not open~n";
get_error_msg(336003096) -> "Data type ~p is not supported for EXTERNAL TABLES. Relation '~p', field '~p'~n";
get_error_msg(336003097) -> "Feature not supported on ODS version older than ~p.~p~n";
get_error_msg(336003098) -> "Primary key required on table ~p~n";
get_error_msg(336003099) -> "UPDATE OR INSERT field list does not match primary key of table ~p~n";
...
get_error_msg(336003104) -> "To be used with RDB$RECORD_VERSION, ~p must be a table or a view of single table~n";
get_error_msg(336068645) -> "BLOB Filter ~p not found~n";
get_error_msg(336068649) -> "Function ~p not found~n";
get_error_msg(336068656) -> "Index not found~n";
get_error_msg(336068662) -> "View ~p not found~n";
get_error_msg(336068697) -> "Domain not found~n";
get_error_msg(336068717) -> "Triggers created automatically cannot be modified~n";
get_error_msg(336068740) -> "Table ~p already exists~n";
get_error_msg(336068748) -> "Procedure ~p not found~n";
get_error_msg(336068752) -> "Exception not found~n";
get_error_msg(336068754) -> "Parameter ~p in procedure ~p not found~n";
get_error_msg(336068755) -> "Trigger ~p not found~n";
get_error_msg(336068759) -> "Character set ~p not found~n";
get_error_msg(336068760) -> "Collation ~p not found~n";
get_error_msg(336068763) -> "Role ~p not found~n";
get_error_msg(336068767) -> "Name longer than database column size~n";
get_error_msg(336068784) -> "column ~p does not exist in table/view ~p~n";
get_error_msg(336068796) -> "SQL role ~p does not exist~n";
get_error_msg(336068797) -> "user ~p has no grant admin option on SQL role ~p~n";
get_error_msg(336068798) -> "user ~p is not a member of SQL role ~p~n";
get_error_msg(336068799) -> "~p is not the owner of SQL role ~p~n";
get_error_msg(336068800) -> "~p is a SQL role and not a user~n";
get_error_msg(336068801) -> "user name ~p could not be used for SQL role~n";
get_error_msg(336068802) -> "SQL role ~p already exists~n";
get_error_msg(336068803) -> "keyword ~p can not be used as a SQL role name~n";
...
get_error_msg(336068812) -> "Cannot rename domain ~p to ~p.  A domain with that name already exists.~n";
get_error_msg(336068813) -> "Cannot rename column ~p to ~p.  A column with that name already exists in table ~p.~n";
get_error_msg(336068814) -> "Column ~p from table ~p is referenced in ~p~n";
get_error_msg(336068815) -> "Cannot change datatype for column ~p.  Changing datatype is not supported for BLOB or ARRAY columns.~n";
get_error_msg(336068816) -> "New size specified for column ~p must be at least ~p characters.~n";
get_error_msg(336068817) -> "Cannot change datatype for ~p.  Conversion from base type ~p to ~p is not supported.~n";
get_error_msg(336068818) -> "Cannot change datatype for column ~p from a character type to a non-character type.~n";
get_error_msg(336068820) -> "Zero length identifiers are not allowed~n";
get_error_msg(336068822) -> "Sequence ~p not found~n";
...
get_error_msg(336068840) -> "~p cannot reference ~p~n";
get_error_msg(336068843) -> "Collation ~p is used in table ~p (field name ~p) and cannot be dropped~n";
get_error_msg(336068844) -> "Collation ~p is used in domain ~p and cannot be dropped~n";
get_error_msg(336068845) -> "Cannot delete system collation~n";
get_error_msg(336068846) -> "Cannot delete default collation of CHARACTER SET ~p~n";
get_error_msg(336068849) -> "Table ~p not found~n";
get_error_msg(336068851) -> "Collation ~p is used in procedure ~p (parameter name ~p) and cannot be dropped~n";
get_error_msg(336068852) -> "New scale specified for column ~p must be at most ~p.~n";
get_error_msg(336068853) -> "New precision specified for column ~p must be at least ~p.~n";
get_error_msg(336068855) -> "Warning: ~p on ~p is not granted to ~p.~n";
get_error_msg(336068856) -> "Feature '~p' is not supported in ODS ~p.~p~n";
get_error_msg(336068857) -> "Cannot add or remove COMPUTED from column ~p~n";
get_error_msg(336068858) -> "Password should not be empty string~n";
get_error_msg(336068859) -> "Index ~p already exists~n";
get_error_msg(336068864) -> "Package ~p not found~n";
get_error_msg(336068865) -> "Schema ~p not found~n";
get_error_msg(336068866) -> "Cannot ALTER or DROP system procedure ~p~n";
get_error_msg(336068867) -> "Cannot ALTER or DROP system trigger ~p~n";
get_error_msg(336068868) -> "Cannot ALTER or DROP system function ~p~n";
get_error_msg(336068869) -> "Invalid DDL statement for procedure ~p~n";
get_error_msg(336068870) -> "Invalid DDL statement for trigger ~p~n";
get_error_msg(336068871) -> "Function ~p has not been defined on the package body ~p~n";
get_error_msg(336068872) -> "Procedure ~p has not been defined on the package body ~p~n";
get_error_msg(336068873) -> "Function ~p has a signature mismatch on package body ~p~n";
get_error_msg(336068874) -> "Procedure ~p has a signature mismatch on package body ~p~n";
get_error_msg(336068875) -> "Default values for parameters are allowed only in declaration of packaged procedure ~p.~p~n";
get_error_msg(336068877) -> "Package body ~p already exists~n";
get_error_msg(336068878) -> "Invalid DDL statement for function ~p~n";
get_error_msg(336068879) -> "Cannot alter new style function ~p with ALTER EXTERNAL FUNCTION. Use ALTER FUNCTION instead.~n";
get_error_msg(336068886) -> "Parameter ~p in function ~p not found~n";
get_error_msg(336068887) -> "Parameter ~p of routine ~p not found~n";
get_error_msg(336068888) -> "Parameter ~p of routine ~p is ambiguous (found in both procedures and functions). Use a specifier keyword.~n";
get_error_msg(336068889) -> "Collation ~p is used in function ~p (parameter name ~p) and cannot be dropped~n";
get_error_msg(336068890) -> "Domain ~p is used in function ~p (parameter name ~p) and cannot be dropped~n";
get_error_msg(336068891) -> "ALTER USER requires at least one clause to be specified~n";
get_error_msg(336068894) -> "Duplicate ~p ~p~n";
get_error_msg(336068895) -> "System ~p ~p cannot be modified~n";
get_error_msg(336068896) -> "INCREMENT BY 0 is an illegal option for sequence ~p~n";
get_error_msg(336068897) -> "Can't use ~p in FOREIGN KEY constraint~n";
get_error_msg(336068898) -> "Default values for parameters are allowed only in declaration of packaged function ~p.~p~n";
get_error_msg(336330753) -> "found unknown switch~n";
get_error_msg(336330754) -> "page size parameter missing~n";
get_error_msg(336330755) -> "Page size specified (~p) greater than limit (16384 bytes)~n";
...
get_error_msg(336330758) -> "device type ~p not known~n";
...
get_error_msg(336330764) -> "expected page size, encountered '~p'~n";
get_error_msg(336330765) -> "REPLACE specified, but the first file ~p is a database~n";
get_error_msg(336330766) -> "database ~p already exists.  To replace it, use the -REP switch~n";
get_error_msg(336330767) -> "device type not specified~n";
get_error_msg(336330772) -> "gds_$blob_info failed~n";
get_error_msg(336330773) -> "do not understand BLOB INFO item ~p~n";
...
get_error_msg(336330778) -> "data type ~p not understood~n";
...
get_error_msg(336330785) -> "failed to create database ~p~n";
get_error_msg(336330786) -> "RESTORE: decompression length error~n";
get_error_msg(336330787) -> "cannot find table ~p~n";
...
get_error_msg(336330792) -> "wrong length record, expected ~p encountered ~p~n";
get_error_msg(336330793) -> "expected data attribute~n";
get_error_msg(336330794) -> "Failed in store_blr_gen_id~n";
get_error_msg(336330795) -> "do not recognize record type ~p~n";
get_error_msg(336330796) -> "Expected backup version 1..10.  Found ~p~n";
...
get_error_msg(336330803) -> "database format ~p is too old to restore to~n";
get_error_msg(336330804) -> "array dimension for column ~p is invalid~n";
get_error_msg(336330807) -> "Expected XDR record length~n";
get_error_msg(336330817) -> "cannot open backup file ~p~n";
get_error_msg(336330818) -> "cannot open status and error output file ~p~n";
get_error_msg(336330934) -> "blocking factor parameter missing~n";
get_error_msg(336330935) -> "expected blocking factor, encountered '~p'~n";
...
get_error_msg(336330953) -> "expected number of bytes to be skipped, encountered '~p'~n";
...
get_error_msg(336330985) -> "could not drop database ~p (database might be in use)~n";
...
get_error_msg(336331011) -> "expected page buffers, encountered '~p'~n";
get_error_msg(336331012) -> "page buffers is allowed only on restore or create~n";
get_error_msg(336331014) -> "size specification either missing or incorrect for file ~p~n";
get_error_msg(336331015) -> "file ~p out of sequence~n";
...
get_error_msg(336331019) -> "backup file ~p might be corrupt~n";
get_error_msg(336331020) -> "database file specification missing~n";
get_error_msg(336331021) -> "can't write a header record to file ~p~n";
get_error_msg(336331022) -> "free disk space exhausted~n";
get_error_msg(336331023) -> "file size given (~p) is less than minimum allowed (~p)~n";
...
get_error_msg(336331079) -> "verbose interval value cannot be smaller than ~p~n";
get_error_msg(336331081) -> "verify (verbose) and verbint options are mutually exclusive~n";
get_error_msg(336331082) -> "option -~p is allowed only on restore or create~n";
get_error_msg(336331083) -> "option -~p is allowed only on backup~n";
get_error_msg(336331084) -> "options -~p and -~p are mutually exclusive~n";
get_error_msg(336331085) -> "parameter for option -~p was already specified with value '~p'~n";
get_error_msg(336331086) -> "option -~p was already specified~n";
get_error_msg(336331091) -> "dependency depth greater than ~p for view ~p~n";
get_error_msg(336331092) -> "value greater than ~p when calculating length of rdb$db_key for view ~p~n";
...
get_error_msg(336331096) -> "Expected backup version ~p..~p.  Found ~p~n";
get_error_msg(336331100) -> "database format ~p is too old to backup~n";
get_error_msg(336397205) -> "ODS versions before ODS~p are not supported~n";
get_error_msg(336397206) -> "Table ~p does not exist~n";
get_error_msg(336397207) -> "View ~p does not exist~n";
get_error_msg(336397208) -> "At line ~p, column ~p~n";
get_error_msg(336397209) -> "At unknown line and column~n";
get_error_msg(336397210) -> "Column ~p cannot be repeated in ~p statement~n";
get_error_msg(336397211) -> "Too many values (more than ~p) in member list to match against~n";
get_error_msg(336397212) -> "Array and BLOB data types not allowed in computed field~n";
get_error_msg(336397213) -> "Implicit domain name ~p not allowed in user created domain~n";
get_error_msg(336397214) -> "scalar operator used on field ~p which is not an array~n";
...
get_error_msg(336397217) -> "Cannot include the same field (~p.~p) twice in the ORDER BY clause with conflicting sorting options~n";
get_error_msg(336397218) -> "column list from derived table ~p has more columns than the number of items in its SELECT statement~n";
get_error_msg(336397219) -> "column list from derived table ~p has less columns than the number of items in its SELECT statement~n";
get_error_msg(336397220) -> "no column name specified for column number ~p in derived table ~p~n";
get_error_msg(336397221) -> "column ~p was specified multiple times for derived table ~p~n";
...
get_error_msg(336397225) -> "Recursive CTE member (~p) can refer itself only in FROM clause~n";
get_error_msg(336397226) -> "CTE '~p' has cyclic dependencies~n";
...
get_error_msg(336397229) -> "Recursive CTE (~p) must be an UNION~n";
get_error_msg(336397230) -> "CTE '~p' defined non-recursive member after recursive~n";
get_error_msg(336397231) -> "Recursive member of CTE '~p' has ~p clause~n";
get_error_msg(336397232) -> "Recursive members of CTE (~p) must be linked with another members via UNION ALL~n";
get_error_msg(336397233) -> "Non-recursive member is missing in CTE '~p'~n";
get_error_msg(336397234) -> "WITH clause can't be nested~n";
get_error_msg(336397235) -> "column ~p appears more than once in USING clause~n";
get_error_msg(336397236) -> "feature is not supported in dialect ~p~n";
get_error_msg(336397237) -> "CTE '~p' is not used in query~n";
get_error_msg(336397238) -> "column ~p appears more than once in ALTER VIEW~n";
get_error_msg(336397239) -> "~p is not supported inside IN AUTONOMOUS TRANSACTION block~n";
get_error_msg(336397240) -> "Unknown node type ~p in dsql/GEN_expr~n";
get_error_msg(336397241) -> "Argument for ~p in dialect 1 must be string or numeric~n";
get_error_msg(336397242) -> "Argument for ~p in dialect 3 must be numeric~n";
...
get_error_msg(336397258) -> "ALTER CHARACTER SET ~p failed~n";
get_error_msg(336397259) -> "COMMENT ON ~p failed~n";
get_error_msg(336397260) -> "CREATE FUNCTION ~p failed~n";
get_error_msg(336397261) -> "ALTER FUNCTION ~p failed~n";
get_error_msg(336397262) -> "CREATE OR ALTER FUNCTION ~p failed~n";
get_error_msg(336397263) -> "DROP FUNCTION ~p failed~n";
get_error_msg(336397264) -> "RECREATE FUNCTION ~p failed~n";
get_error_msg(336397265) -> "CREATE PROCEDURE ~p failed~n";
get_error_msg(336397266) -> "ALTER PROCEDURE ~p failed~n";
get_error_msg(336397267) -> "CREATE OR ALTER PROCEDURE ~p failed~n";
get_error_msg(336397268) -> "DROP PROCEDURE ~p failed~n";
get_error_msg(336397269) -> "RECREATE PROCEDURE ~p failed~n";
get_error_msg(336397270) -> "CREATE TRIGGER ~p failed~n";
get_error_msg(336397271) -> "ALTER TRIGGER ~p failed~n";
get_error_msg(336397272) -> "CREATE OR ALTER TRIGGER ~p failed~n";
get_error_msg(336397273) -> "DROP TRIGGER ~p failed~n";
get_error_msg(336397274) -> "RECREATE TRIGGER ~p failed~n";
get_error_msg(336397275) -> "CREATE COLLATION ~p failed~n";
get_error_msg(336397276) -> "DROP COLLATION ~p failed~n";
get_error_msg(336397277) -> "CREATE DOMAIN ~p failed~n";
get_error_msg(336397278) -> "ALTER DOMAIN ~p failed~n";
get_error_msg(336397279) -> "DROP DOMAIN ~p failed~n";
get_error_msg(336397280) -> "CREATE EXCEPTION ~p failed~n";
get_error_msg(336397281) -> "ALTER EXCEPTION ~p failed~n";
get_error_msg(336397282) -> "CREATE OR ALTER EXCEPTION ~p failed~n";
get_error_msg(336397283) -> "RECREATE EXCEPTION ~p failed~n";
get_error_msg(336397284) -> "DROP EXCEPTION ~p failed~n";
get_error_msg(336397285) -> "CREATE SEQUENCE ~p failed~n";
get_error_msg(336397286) -> "CREATE TABLE ~p failed~n";
get_error_msg(336397287) -> "ALTER TABLE ~p failed~n";
get_error_msg(336397288) -> "DROP TABLE ~p failed~n";
get_error_msg(336397289) -> "RECREATE TABLE ~p failed~n";
get_error_msg(336397290) -> "CREATE PACKAGE ~p failed~n";
get_error_msg(336397291) -> "ALTER PACKAGE ~p failed~n";
get_error_msg(336397292) -> "CREATE OR ALTER PACKAGE ~p failed~n";
get_error_msg(336397293) -> "DROP PACKAGE ~p failed~n";
get_error_msg(336397294) -> "RECREATE PACKAGE ~p failed~n";
get_error_msg(336397295) -> "CREATE PACKAGE BODY ~p failed~n";
get_error_msg(336397296) -> "DROP PACKAGE BODY ~p failed~n";
get_error_msg(336397297) -> "RECREATE PACKAGE BODY ~p failed~n";
get_error_msg(336397298) -> "CREATE VIEW ~p failed~n";
get_error_msg(336397299) -> "ALTER VIEW ~p failed~n";
get_error_msg(336397300) -> "CREATE OR ALTER VIEW ~p failed~n";
get_error_msg(336397301) -> "RECREATE VIEW ~p failed~n";
get_error_msg(336397302) -> "DROP VIEW ~p failed~n";
get_error_msg(336397303) -> "DROP SEQUENCE ~p failed~n";
get_error_msg(336397304) -> "RECREATE SEQUENCE ~p failed~n";
get_error_msg(336397305) -> "DROP INDEX ~p failed~n";
get_error_msg(336397306) -> "DROP FILTER ~p failed~n";
get_error_msg(336397307) -> "DROP SHADOW ~p failed~n";
get_error_msg(336397308) -> "DROP ROLE ~p failed~n";
get_error_msg(336397309) -> "DROP USER ~p failed~n";
get_error_msg(336397310) -> "CREATE ROLE ~p failed~n";
get_error_msg(336397311) -> "ALTER ROLE ~p failed~n";
get_error_msg(336397312) -> "ALTER INDEX ~p failed~n";
get_error_msg(336397313) -> "ALTER DATABASE failed~n";
get_error_msg(336397314) -> "CREATE SHADOW ~p failed~n";
get_error_msg(336397315) -> "DECLARE FILTER ~p failed~n";
get_error_msg(336397316) -> "CREATE INDEX ~p failed~n";
get_error_msg(336397317) -> "CREATE USER ~p failed~n";
get_error_msg(336397318) -> "ALTER USER ~p failed~n";
...
get_error_msg(336397322) -> "~p MAPPING ~p failed~n";
get_error_msg(336397323) -> "ALTER SEQUENCE ~p failed~n";
get_error_msg(336397324) -> "CREATE GENERATOR ~p failed~n";
get_error_msg(336397325) -> "SET GENERATOR ~p failed~n";
...
get_error_msg(336397329) -> "WITH LOCK cannot be used with ~p~n";
get_error_msg(336397330) -> "Number of arguments (~p) exceeds the maximum (~p) number of EXCEPTION USING arguments~n";
get_error_msg(336397331) -> "String literal with ~p bytes exceeds the maximum length of ~p bytes~n";
get_error_msg(336397332) -> "String literal with ~p characters exceeds the maximum length of ~p characters for the ~p character set~n";
get_error_msg(336397333) -> "Too many BEGIN...END nesting. Maximum level is ~p~n";
...
get_error_msg(336723990) -> "record not found for user: ~p~n";
...
get_error_msg(336920579) -> "Wrong ODS version, expected ~p, encountered ~p~n";
get_error_msg(336920580) -> "Unexpected end of database file.~n";
get_error_msg(336920605) -> "Can't open database file ~p~n";
...
get_error_msg(336986116) -> "Unknown tag (~p) in info_svr_db_info block after isc_svc_query()~n";
get_error_msg(336986117) -> "Unknown tag (~p) in isc_svc_query() results~n";
get_error_msg(336986118) -> "Unknown switch '~p'~n";
get_error_msg(336986159) -> "Wrong value for shutdown mode~n";
get_error_msg(336986160) -> "could not open file ~p~n";
get_error_msg(336986161) -> "could not read file ~p~n";
get_error_msg(336986162) -> "empty file ~p~n";
get_error_msg(336986164) -> "Invalid or missing parameter for switch ~p~n";
get_error_msg(337051649) -> "Switches trusted_user and trusted_role are not supported from command line~n";
get_error_msg(337117213) -> "Missing parameter for switch ~p~n";
get_error_msg(337117214) -> "Only one of -LOCK, -UNLOCK, -FIXUP, -BACKUP or -RESTORE should be specified~n";
get_error_msg(337117215) -> "Unrecognized parameter ~p~n";
get_error_msg(337117216) -> "Unknown switch ~p~n";
get_error_msg(337117217) -> "Fetch password can't be used in service mode~n";
get_error_msg(337117218) -> "Error working with password file '~p'~n";
...
get_error_msg(337117223) -> "IO error reading file: ~p~n";
get_error_msg(337117224) -> "IO error writing file: ~p~n";
get_error_msg(337117225) -> "IO error seeking file: ~p~n";
get_error_msg(337117226) -> "Error opening database file: ~p~n";
get_error_msg(337117227) -> "Error in posix_fadvise(~p) for database ~p~n";
get_error_msg(337117228) -> "Error creating database file: ~p~n";
get_error_msg(337117229) -> "Error opening backup file: ~p~n";
get_error_msg(337117230) -> "Error creating backup file: ~p~n";
get_error_msg(337117231) -> "Unexpected end of database file ~p~n";
get_error_msg(337117232) -> "Database ~p is not in state (~p) to be safely fixed up~n";
get_error_msg(337117233) -> "Database error~n";
get_error_msg(337117234) -> "Username or password is too long~n";
get_error_msg(337117235) -> "Cannot find record for database '~p' backup level ~p in the backup history~n";
get_error_msg(337117236) -> "Internal error. History query returned null SCN or GUID~n";
get_error_msg(337117237) -> "Unexpected end of file when reading header of database file '~p' (stage ~p)~n";
get_error_msg(337117238) -> "Internal error. Database file is not locked. Flags are ~p~n";
get_error_msg(337117239) -> "Internal error. Cannot get backup guid clumplet~n";
get_error_msg(337117240) -> "Internal error. Database page ~p had been changed during backup (page SCN=~p, backup SCN=~p)~n";
...
get_error_msg(337117243) -> "Unexpected end of file when reading header of backup file: ~p~n";
get_error_msg(337117244) -> "Invalid incremental backup file: ~p~n";
get_error_msg(337117245) -> "Unsupported version ~p of incremental backup file: ~p~n";
get_error_msg(337117246) -> "Invalid level ~p of incremental backup file: ~p, expected ~p~n";
get_error_msg(337117247) -> "Wrong order of backup files or invalid incremental backup file detected, file: ~p~n";
get_error_msg(337117248) -> "Unexpected end of backup file: ~p~n";
get_error_msg(337117249) -> "Error creating database file: ~p via copying from: ~p~n";
get_error_msg(337117250) -> "Unexpected end of file when reading header of restored database file (stage ~p)~n";
get_error_msg(337117251) -> "Cannot get backup guid clumplet from L0 backup~n";
get_error_msg(337117255) -> "Wrong parameter ~p for switch -D, need ON or OFF~n";
get_error_msg(337117257) -> "Terminated due to user request~n";
get_error_msg(337117259) -> "Too complex decompress command (> ~p arguments)~n";
get_error_msg(337182750) -> "conflicting actions '~p' and '~p' found~n";
get_error_msg(337182751) -> "action switch not found~n";
get_error_msg(337182752) -> "switch '~p' must be set only once~n";
get_error_msg(337182753) -> "value for switch '~p' is missing~n";
get_error_msg(337182754) -> "invalid value ('~p') for switch '~p'~n";
get_error_msg(337182755) -> "unknown switch '~p' encountered~n";
get_error_msg(337182756) -> "switch '~p' can be used by service only~n";
get_error_msg(337182757) -> "switch '~p' can be used by interactive user only~n";
get_error_msg(337182758) -> "mandatory parameter '~p' for switch '~p' is missing~n";
get_error_msg(337182759) -> "parameter '~p' is incompatible with action '~p'~n";
get_error_msg(337182760) -> "mandatory switch '~p' is missing~n";
get_error_msg(_) -> "".

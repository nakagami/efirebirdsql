...
get_error_msg(335544359) -> "attempted update of read-only column ~s~n";
...
get_error_msg(335544583) -> "SQLDA error~n";
...
get_error_msg(335544637) -> "table or procedure ~s is not referenced in plan~n";
get_error_msg(335544638) -> "table or procedure ~s is referenced more than once in plan; use aliases to distinguish~n";
get_error_msg(335544639) -> "table or procedure ~s is referenced in the plan but not the from list~n";
...
get_error_msg(335544659) -> "table or procedure ~s is referenced twice in view; use an alias to distinguish~n";
...
get_error_msg(335544773) -> "Floating-point inexact result.  The result of a floating-point operation cannot be represented as a decimal fraction.~n";
...
get_error_msg(335544783) -> "Illegal Instruction. The Code attempted to perform an illegal operation.~n";
...
get_error_msg(335544788) -> "Unable to perform operation~n";
...
get_error_msg(335544816) -> "Function ~s~n";
...
get_error_msg(335544921) -> "Execute statement error at ~s :\n~sData source : ~s~n";
...
get_error_msg(335544926) -> "Execute statement error at ~s :\n~sStatement : ~s\nData source : ~s~n";
...
get_error_msg(335544984) -> "Shared memory area is probably already created by another engine instance in another Windows session~n";
...
get_error_msg(335545029) -> "Install incomplete. To complete security database initialization please CREATE USER. For details read doc/README.security_database.txt.~n";
...
get_error_msg(335545109) -> "Page requires encryption but crypt plugin is missing~n";
get_error_msg(335545110) -> "Maximum index depth (~s levels) is reached~n";
get_error_msg(335545111) -> "System privilege ~s does not exist~n";
get_error_msg(335545112) -> "System privilege ~s is missing~n";
get_error_msg(335545113) -> "Invalid or missing checksum of encrypted database~n";
get_error_msg(335545114) -> "You must have SYSDBA rights at this server~n";
get_error_msg(335545115) -> "Cannot open cursor for non-SELECT statement~n";
get_error_msg(335545116) -> "If <window frame bound 1> specifies ~s, then <window frame bound 2> shall not specify ~s~n";
get_error_msg(335545117) -> "RANGE based window with <expr> {PRECEDING | FOLLOWING} cannot have ORDER BY with more than one value~n";
get_error_msg(335545118) -> "RANGE based window with <offset> PRECEDING/FOLLOWING must have a single ORDER BY key of numerical, date, time or timestamp types~n";
get_error_msg(335545119) -> "Window RANGE/ROWS PRECEDING/FOLLOWING value must be of a numerical type~n";
get_error_msg(335545120) -> "Invalid PRECEDING or FOLLOWING offset in window function: cannot be negative~n";
get_error_msg(335545121) -> "Window ~s not found~n";
get_error_msg(335545122) -> "Cannot use PARTITION BY clause while overriding the window ~s~n";
get_error_msg(335545123) -> "Cannot use ORDER BY clause while overriding the window ~s which already has an ORDER BY clause~n";
get_error_msg(335545124) -> "Cannot override the window ~s because it has a frame clause. Tip: it can be used without parenthesis in OVER~n";
get_error_msg(335545125) -> "Duplicate window definition for ~s~n";
get_error_msg(335545126) -> "SQL statement is too long. Maximum size is ~s bytes.~n";
get_error_msg(335545127) -> "Config level timeout expired.~n";
get_error_msg(335545128) -> "Attachment level timeout expired.~n";
get_error_msg(335545129) -> "Statement level timeout expired.~n";
get_error_msg(335545130) -> "Killed by database administrator.~n";
get_error_msg(335545131) -> "Idle timeout expired.~n";
get_error_msg(335545132) -> "Database is shutdown.~n";
get_error_msg(335545133) -> "Engine is shutdown.~n";
get_error_msg(335545134) -> "OVERRIDING clause can be used only when an identity column is present in the INSERT's field list for table/view ~s~n";
get_error_msg(335545135) -> "OVERRIDING SYSTEM VALUE can be used only for identity column defined as 'GENERATED ALWAYS' in INSERT for table/view ~s~n";
get_error_msg(335545136) -> "OVERRIDING USER VALUE can be used only for identity column defined as 'GENERATED BY DEFAULT' in INSERT for table/view ~s~n";
get_error_msg(335545137) -> "OVERRIDING clause should be used when an identity column defined as 'GENERATED ALWAYS' is present in the INSERT's field list for table table/view ~s~n";
get_error_msg(335545138) -> "DecFloat precision must be 16 or 34~n";
get_error_msg(335545139) -> "Decimal float divide by zero.  The code attempted to divide a DECFLOAT value by zero.~n";
get_error_msg(335545140) -> "Decimal float inexact result.  The result of an operation cannot be represented as a decimal fraction.~n";
get_error_msg(335545141) -> "Decimal float invalid operation.  An indeterminant error occurred during an operation.~n";
get_error_msg(335545142) -> "Decimal float overflow.  The exponent of a result is greater than the magnitude allowed.~n";
get_error_msg(335545143) -> "Decimal float underflow.  The exponent of a result is less than the magnitude allowed.~n";
get_error_msg(335545144) -> "Sub-function ~s has not been defined~n";
get_error_msg(335545145) -> "Sub-procedure ~s has not been defined~n";
get_error_msg(335545146) -> "Sub-function ~s has a signature mismatch with its forward declaration~n";
get_error_msg(335545147) -> "Sub-procedure ~s has a signature mismatch with its forward declaration~n";
get_error_msg(335545148) -> "Default values for parameters are not allowed in definition of the previously declared sub-function ~s~n";
get_error_msg(335545149) -> "Default values for parameters are not allowed in definition of the previously declared sub-procedure ~s~n";
get_error_msg(335545150) -> "Sub-function ~s was declared but not implemented~n";
get_error_msg(335545151) -> "Sub-procedure ~s was declared but not implemented~n";
get_error_msg(335545152) -> "Invalid HASH algorithm ~s~n";
get_error_msg(335545153) -> "Expression evaluation error for index \"~s\" on table \"~s\"~n";
get_error_msg(335545154) -> "Invalid decfloat trap state ~s~n";
get_error_msg(335545155) -> "Invalid decfloat rounding mode ~s~n";
get_error_msg(335545156) -> "Invalid part ~s to calculate the ~s of a DATE/TIMESTAMP~n";
get_error_msg(335545157) -> "Expected DATE/TIMESTAMP value in ~s~n";
get_error_msg(335545158) -> "Precision must be from ~s to ~s~n";
get_error_msg(335545159) -> "invalid batch handle~n";
get_error_msg(335545160) -> "Bad international character in tag ~s~n";
get_error_msg(335545161) -> "Null data in parameters block with non-zero length~n";
get_error_msg(335545162) -> "Items working with running service and getting generic server information should not be mixed in single info block~n";
get_error_msg(335545163) -> "Unknown information item, code ~s~n";
get_error_msg(335545164) -> "Wrong version of blob parameters block ~s, should be ~s~n";
get_error_msg(335545165) -> "User management plugin is missing or failed to load~n";
get_error_msg(335545166) -> "Missing entrypoint ~s in ICU library~n";
get_error_msg(335545167) -> "Could not find acceptable ICU library~n";
get_error_msg(335545168) -> "Name ~s not found in system MetadataBuilder~n";
get_error_msg(335545169) -> "Parse to tokens error~n";
get_error_msg(335545170) -> "Error opening international conversion descriptor from ~s to ~s~n";
get_error_msg(335545171) -> "Message ~s is out of range, only ~s messages in batch~n";
get_error_msg(335545172) -> "Detailed error info for message ~s is missing in batch~n";
get_error_msg(335545173) -> "Compression stream init error ~s~n";
get_error_msg(335545174) -> "Decompression stream init error ~s~n";
get_error_msg(335545175) -> "Segment size (~s) should not exceed 65535 (64K - 1) when using segmented blob~n";
get_error_msg(335545176) -> "Invalid blob policy in the batch for ~s() call~n";
get_error_msg(335545177) -> "Can't change default BPB after adding any data to batch~n";
get_error_msg(335545178) -> "Unexpected info buffer structure querying for server batch parameters~n";
get_error_msg(335545179) -> "Duplicated segment ~s in multisegment connect block parameter~n";
get_error_msg(335545180) -> "Plugin not supported by network protocol~n";
get_error_msg(335545181) -> "Error parsing message format~n";
get_error_msg(335545182) -> "Wrong version of batch parameters block ~s, should be ~s~n";
get_error_msg(335545183) -> "Message size (~s) in batch exceeds internal buffer size (~s)~n";
get_error_msg(335545184) -> "Batch already opened for this statement~n";
get_error_msg(335545185) -> "Invalid type of statement used in batch~n";
get_error_msg(335545186) -> "Statement used in batch must have parameters~n";
get_error_msg(335545187) -> "There are no blobs in associated with batch statement~n";
get_error_msg(335545188) -> "appendBlobData() is used to append data to last blob but no such blob was added to the batch~n";
get_error_msg(335545189) -> "Portions of data, passed as blob stream, should have size multiple to the alignment required for blobs~n";
get_error_msg(335545190) -> "Repeated blob id ~s in registerBlob()~n";
get_error_msg(335545191) -> "Blob buffer format error~n";
get_error_msg(335545192) -> "Unusable (too small) data remained in ~s buffer~n";
get_error_msg(335545193) -> "Blob continuation should not contain BPB~n";
get_error_msg(335545194) -> "Size of BPB (~s) greater than remaining data (~s)~n";
get_error_msg(335545195) -> "Size of segment (~s) greater than current BLOB data (~s)~n";
get_error_msg(335545196) -> "Size of segment (~s) greater than available data (~s)~n";
get_error_msg(335545197) -> "Unknown blob ID ~s in the batch message~n";
get_error_msg(335545198) -> "Internal buffer overflow - batch too big~n";
get_error_msg(335545199) -> "Numeric literal too long~n";
get_error_msg(335545200) -> "Error using events in mapping shared memory: ~s~n";
get_error_msg(335545201) -> "Global mapping memory overflow~n";
get_error_msg(335545202) -> "Header page overflow - too many clumplets on it~n";
get_error_msg(335545203) -> "No matching client/server authentication plugins configured for execute statement in embedded datasource~n";
get_error_msg(335545204) -> "Missing database encryption key for your attachment~n";
get_error_msg(335545205) -> "Key holder plugin ~s failed to load~n";
get_error_msg(335545206) -> "Cannot reset user session~n";
get_error_msg(335545207) -> "There are open transactions (~s active)~n";
get_error_msg(335545208) -> "Session was reset with warning(s)~n";
get_error_msg(335545209) -> "Transaction is rolled back due to session reset, all changes are lost~n";
get_error_msg(335545210) -> "Plugin ~s:~n";
get_error_msg(335545211) -> "PARAMETER ~s~n";
get_error_msg(335545212) -> "Starting page number for file ~s must be ~s or greater~n";
get_error_msg(335545213) -> "Invalid time zone offset: ~s - must use format +/-hours:minutes and be between -14:00 and +14:00~n";
get_error_msg(335545214) -> "Invalid time zone region: ~s~n";
get_error_msg(335545215) -> "Invalid time zone ID: ~s~n";
get_error_msg(335545216) -> "Wrong base64 text length ~s, should be multiple of 4~n";
get_error_msg(335545217) -> "Invalid first parameter datatype - need string or blob~n";
get_error_msg(335545218) -> "Error registering ~s - probably bad tomcrypt library~n";
get_error_msg(335545219) -> "Unknown crypt algorithm ~s in USING clause~n";
get_error_msg(335545220) -> "Should specify mode parameter for symmetric cipher~n";
get_error_msg(335545221) -> "Unknown symmetric crypt mode specified~n";
get_error_msg(335545222) -> "Mode parameter makes no sense for chosen cipher~n";
get_error_msg(335545223) -> "Should specify initialization vector (IV) for chosen cipher and/or mode~n";
get_error_msg(335545224) -> "Initialization vector (IV) makes no sense for chosen cipher and/or mode~n";
get_error_msg(335545225) -> "Invalid counter endianess ~s~n";
get_error_msg(335545226) -> "Counter endianess parameter is not used in mode ~s~n";
get_error_msg(335545227) -> "Too big counter value ~s, maximum ~s can be used~n";
get_error_msg(335545228) -> "Counter length/value parameter is not used with ~s ~s~n";
get_error_msg(335545229) -> "Invalid initialization vector (IV) length ~s, need ~s~n";
get_error_msg(335545230) -> "TomCrypt library error: ~s~n";
get_error_msg(335545231) -> "Starting PRNG yarrow~n";
get_error_msg(335545232) -> "Setting up PRNG yarrow~n";
get_error_msg(335545233) -> "Initializing ~s mode~n";
get_error_msg(335545234) -> "Encrypting in ~s mode~n";
get_error_msg(335545235) -> "Decrypting in ~s mode~n";
get_error_msg(335545236) -> "Initializing cipher ~s~n";
get_error_msg(335545237) -> "Encrypting using cipher ~s~n";
get_error_msg(335545238) -> "Decrypting using cipher ~s~n";
get_error_msg(335545239) -> "Setting initialization vector (IV) for ~s~n";
get_error_msg(335545240) -> "Invalid initialization vector (IV) length ~s, need  8 or 12~n";
get_error_msg(335545241) -> "Encoding ~s~n";
get_error_msg(335545242) -> "Decoding ~s~n";
get_error_msg(335545243) -> "Importing RSA key~n";
get_error_msg(335545244) -> "Invalid OAEP packet~n";
get_error_msg(335545245) -> "Unknown hash algorithm ~s~n";
get_error_msg(335545246) -> "Making RSA key~n";
get_error_msg(335545247) -> "Exporting ~s RSA key~n";
get_error_msg(335545248) -> "RSA-signing data~n";
get_error_msg(335545249) -> "Verifying RSA-signed data~n";
get_error_msg(335545250) -> "Invalid key length ~s, need 16 or 32~n";
get_error_msg(335545251) -> "invalid replicator handle~n";
get_error_msg(335545252) -> "Transaction's base snapshot number does not exist~n";
get_error_msg(335545253) -> "Input parameter '~s' is not used in SQL query text~n";
get_error_msg(335545254) -> "Effective user is ~s~n";
get_error_msg(335545255) -> "Invalid time zone bind mode ~s~n";
get_error_msg(335545256) -> "Invalid decfloat bind mode ~s~n";
get_error_msg(335545257) -> "Invalid hex text length ~s, should be multiple of 2~n";
get_error_msg(335545258) -> "Invalid hex digit ~s at position ~s~n";
get_error_msg(335545259) -> "Error processing isc_dpb_set_bind clumplet \"~s\"~n";
get_error_msg(335545260) -> "The following statement failed: ~s~n";
get_error_msg(335545261) -> "Can not convert ~s to ~s~n";
get_error_msg(335545262) -> "cannot update old BLOB~n";
get_error_msg(335545263) -> "cannot read from new BLOB~n";
get_error_msg(335545264) -> "No permission for CREATE ~s operation~n";
get_error_msg(335545265) -> "SUSPEND could not be used without RETURNS clause in PROCEDURE or EXECUTE BLOCK~n";
get_error_msg(335545266) -> "String truncated warning due to the following reason~n";
get_error_msg(335545267) -> "Monitoring data does not fit into the field~n";
get_error_msg(335545268) -> "Engine data does not fit into return value of system function~n";
get_error_msg(335545269) -> "Multiple source records cannot match the same target during MERGE~n";
get_error_msg(335545270) -> "RDB$PAGES written by non-system transaction, DB appears to be damaged~n";
get_error_msg(335545271) -> "Replication error~n";
get_error_msg(335545272) -> "Reset of user session failed. Connection is shut down.~n";
get_error_msg(335545273) -> "File size is less than expected~n";
get_error_msg(335545274) -> "Invalid key length ~s, need >~s~n";
get_error_msg(335545275) -> "Invalid information arguments~n";
get_error_msg(335545276) -> "Empty or NULL parameter ~s is not accepted~n";
get_error_msg(335545277) -> "Undefined local table number ~s~n";
get_error_msg(335545278) -> "Invalid text <~s> after quoted string~n";
get_error_msg(335545279) -> "Missing terminating quote <~s> in the end of quoted string~n";
get_error_msg(335545280) -> "~s: inconsistent shared memory type/version; found ~s, expected ~s~n";
get_error_msg(335545281) -> "~s-bit engine can't open database already opened by ~s-bit engine~n";
get_error_msg(335545282) -> "Procedures cannot specify access type other than NATURAL in the plan~n";
get_error_msg(335545283) -> "Invalid RDB$BLOB_UTIL handle~n";
get_error_msg(335545284) -> "Invalid temporary BLOB ID~n";
get_error_msg(335545285) -> "ODS upgrade failed while adding new system %s~n";
...
get_error_msg(336003105) -> "SQLDA version expected between ~s and ~s, found ~s~n";
get_error_msg(336003106) -> "at SQLVAR index ~s~n";
get_error_msg(336003107) -> "empty pointer to NULL indicator variable~n";
get_error_msg(336003108) -> "empty pointer to data~n";
get_error_msg(336003109) -> "No SQLDA for input values provided~n";
get_error_msg(336003110) -> "No SQLDA for output values provided~n";
get_error_msg(336003111) -> "Wrong number of parameters (expected ~s, got ~s)~n";
get_error_msg(336003112) -> "Invalid DROP SQL SECURITY clause~n";
get_error_msg(336003113) -> "UPDATE OR INSERT value for field ~s, part of the implicit or explicit MATCHING clause, cannot be DEFAULT~n";
...
get_error_msg(336068875) -> "Default values for parameters are not allowed in the definition of a previously declared packaged procedure ~s.~s~n";
...
get_error_msg(336068898) -> "Default values for parameters are not allowed in the definition of a previously declared packaged function ~s.~s~n";
get_error_msg(336068900) -> "role ~s can not be granted to role ~s~n";
get_error_msg(336068904) -> "INCREMENT BY 0 is an illegal option for identity column ~s of table ~s~n";
get_error_msg(336068907) -> "no ~s privilege with grant option on DDL ~s~n";
get_error_msg(336068908) -> "no ~s privilege with grant option on object ~s~n";
get_error_msg(336068909) -> "Function ~s does not exist~n";
get_error_msg(336068910) -> "Procedure ~s does not exist~n";
get_error_msg(336068911) -> "Package ~s does not exist~n";
get_error_msg(336068912) -> "Trigger ~s does not exist~n";
get_error_msg(336068913) -> "View ~s does not exist~n";
get_error_msg(336068914) -> "Table ~s does not exist~n";
get_error_msg(336068915) -> "Exception ~s does not exist~n";
get_error_msg(336068916) -> "Generator/Sequence ~s does not exist~n";
get_error_msg(336068917) -> "Field ~s of table ~s does not exist~n";
get_error_msg(336330753) -> "found unknown switch~n";
get_error_msg(336330754) -> "page size parameter missing~n";
get_error_msg(336330755) -> "Page size specified (~s) greater than limit (32768 bytes)~n";
...
get_error_msg(336330985) -> "could not drop database ~s (no privilege or database might be in use)~n";
...
get_error_msg(336397257) -> "Cannot have more than 255 items in DISTINCT / UNION DISTINCT list~n";
...
get_error_msg(336397334) -> "RECREATE USER ~s failed~n";
...
get_error_msg(336986170) -> "Unknown tag (~s) in isc_info_svc_limbo_trans block after isc_svc_query()~n";
get_error_msg(336986171) -> "Unknown tag (~s) in isc_spb_tra_state block after isc_svc_query()~n";
get_error_msg(336986172) -> "Unknown tag (~s) in isc_spb_tra_advise block after isc_svc_query()~n";
get_error_msg(336986173) -> "Wrong value for replica mode~n";
...
get_error_msg(337117261) -> "Cannot find record for database \"~s\" backup GUID ~s in the backup history~n";
get_error_msg(337117265) -> "Switch -SEQ(UENCE) can be used only with -FIXUP or -RESTORE~n";
get_error_msg(337117268) -> "Wrong parameter value for switch ~s~n";
get_error_msg(337117269) -> "Switch -CLEAN_HISTORY can be used only with -BACKUP~n";
get_error_msg(337117270) -> "-KEEP can be used only with -CLEAN_HISTORY~n";
get_error_msg(337117271) -> "-KEEP is required with -CLEAN_HISTORY~n";
get_error_msg(337117272) -> "-KEEP can be used one time only~n";

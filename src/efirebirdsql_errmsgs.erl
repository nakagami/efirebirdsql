...
get_error_msg(335545118) -> "RANGE based window must have an ORDER BY key of numerical, date, time or timestamp types~n";
...
get_error_msg(335545137) -> "OVERRIDING SYSTEM VALUE should be used to override the value of an identity column defined as 'GENERATED ALWAYS' in table/view ~s~n";
...
get_error_msg(335545178) -> "Unexpected info buffer structure querying for default blob alignment~n";
...
get_error_msg(335545213) -> "Invalid time zone offset: ~s - must be between -14:00 and +14:00~n";
